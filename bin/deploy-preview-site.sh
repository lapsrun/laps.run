...
add_pull_request_comment(){
  ...
  local comment="Thank you for contributing!<br />[Preview]($PREVIEW_URL/$TRAVIS_PULL_REQUEST_SHA/$TRAVIS_PULL_REQUEST_BRANCH/) these changes<br />Link expires: $expires_at"
